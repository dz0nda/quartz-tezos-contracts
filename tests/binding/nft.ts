...
export class balance_event implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.be_pkh.to_mich(), att.pair_to_mich([this.be_token_id.to_mich(), this.be_amount.to_mich()])]);
    }
    equals(v: balance_event): boolean {
        return (this.be_pkh.equals(v.be_pkh) && this.be_pkh.equals(v.be_pkh) && this.be_token_id.equals(v.be_token_id) && this.be_amount.equals(v.be_amount));
    }
}
export class mint_event implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.me_receiver.to_mich(), att.pair_to_mich([this.me_token_id.to_mich(), this.me_amount.to_mich()])]);
    }
    equals(v: mint_event): boolean {
        return (this.me_receiver.equals(v.me_receiver) && this.me_receiver.equals(v.me_receiver) && this.me_token_id.equals(v.me_token_id) && this.me_amount.equals(v.me_amount));
    }
}
export class burn_event implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.bee_consumer.to_mich(), att.pair_to_mich([this.bee_token_id.to_mich(), this.bee_amount.to_mich()])]);
    }
    equals(v: burn_event): boolean {
        return (this.bee_consumer.equals(v.bee_consumer) && this.bee_consumer.equals(v.bee_consumer) && this.bee_token_id.equals(v.bee_token_id) && this.bee_amount.equals(v.bee_amount));
    }
}
export class transfer_event implements att.ArchetypeType {
    ...
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.te_from.to_mich(), att.pair_to_mich([this.te_to.to_mich(), att.pair_to_mich([this.te_token_id.to_mich(), this.te_amount.to_mich()])])]);
    }
    equals(v: transfer_event): boolean {
        return (this.te_from.equals(v.te_from) && this.te_from.equals(v.te_from) && this.te_to.equals(v.te_to) && this.te_token_id.equals(v.te_token_id) && this.te_amount.equals(v.te_amount));
    }
}
...
export class Nft {
    ...
    async set_aleph_contract(params: Partial<ex.Parameters>): Promise<any> {
        if (this.address != undefined) {
    ...
    async mint(iowner: att.Address, itokenid: att.Nat, itokenMetadata: Array<[
        string,
        att.Bytes
    ]>, iroyalties: Array<part>, iamount_aleph: att.Nat, ihash: string, params: Partial<ex.Parameters>): Promise<any> {
        if (this.address != undefined) {
    ...
    async burn(itokenid: att.Nat, params: Partial<ex.Parameters>): Promise<any> {
        if (this.address != undefined) {
    ...
    async collect(dst: att.Address, params: Partial<ex.Parameters>): Promise<any> {
        if (this.address != undefined) {
    ...
    async get_aleph_tokens(): Promise<att.Address> {
        if (this.address != undefined) {
            const storage = await ex.get_storage(this.address);
            return new att.Address(storage.aleph_tokens);
        }
        throw new Error("Contract not initialised");
    }
    async get_aleph_sync(): Promise<att.Address> {
        if (this.address != undefined) {
            const storage = await ex.get_storage(this.address);
            return new att.Address(storage.aleph_sync);
        }
        throw new Error("Contract not initialised");
    }
    ...
    register_balance_event(ep: el.EventProcessor<balance_event>) {
        if (this.address != undefined) {
            el.registerEvent({ source: this.address, filter: tag => { return tag == "balance_event"; }, process: (raw: any, data: el.EventData | undefined) => {
                    const event = (x => {
                        return new balance_event((x => { return new att.Address(x); })(x.pkh), (x => { return new att.Nat(x); })(x.token_id), (x => { return new att.Nat(x); })(x.amount));
                    })(raw);
                    ep(event, data);
                } });
            return;
    ...
    register_mint_event(ep: el.EventProcessor<mint_event>) {
        if (this.address != undefined) {
            el.registerEvent({ source: this.address, filter: tag => { return tag == "mint_event"; }, process: (raw: any, data: el.EventData | undefined) => {
                    const event = (x => {
                        return new mint_event((x => { return new att.Address(x); })(x.pkh), (x => { return new att.Nat(x); })(x.token_id), (x => { return new att.Nat(x); })(x.amount));
                    })(raw);
                    ep(event, data);
                } });
            return;
    ...
    register_burn_event(ep: el.EventProcessor<burn_event>) {
        if (this.address != undefined) {
            el.registerEvent({ source: this.address, filter: tag => { return tag == "burn_event"; }, process: (raw: any, data: el.EventData | undefined) => {
                    const event = (x => {
                        return new burn_event((x => { return new att.Address(x); })(x.pkh), (x => { return new att.Nat(x); })(x.token_id), (x => { return new att.Nat(x); })(x.amount));
                    })(raw);
                    ep(event, data);
                } });
            return;
    ...
    register_transfer_event(ep: el.EventProcessor<transfer_event>) {
        if (this.address != undefined) {
            el.registerEvent({ source: this.address, filter: tag => { return tag == "transfer_event"; }, process: (raw: any, data: el.EventData | undefined) => {
                    const event = (x => {
                        return new transfer_event((x => { return new att.Address(x); })(x.from), (x => { return new att.Address(x); })(x.to), (x => { return new att.Nat(x); })(x.token_id), (x => { return new att.Nat(x); })(x.amount));
                    })(raw);
                    ep(event, data);
                } });
            return;
