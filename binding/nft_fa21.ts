...
export class balance_event implements att.ArchetypeType {
    constructor(public be_pkh: att.Address, public be_token_id: att.Nat, public be_amount: att.Nat) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.be_pkh.to_mich(), this.be_token_id.to_mich(), this.be_amount.to_mich()]);
    }
    equals(v: balance_event): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): balance_event {
        return new balance_event(att.Address.from_mich((input as att.Mpair).args[0]), att.Nat.from_mich((input as att.Mpair).args[1]), att.Nat.from_mich((input as att.Mpair).args[2]));
    }
}
export class mint_event implements att.ArchetypeType {
    constructor(public me_receiver: att.Address, public me_token_id: att.Nat, public me_amount: att.Nat) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.me_receiver.to_mich(), this.me_token_id.to_mich(), this.me_amount.to_mich()]);
    }
    equals(v: mint_event): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): mint_event {
        return new mint_event(att.Address.from_mich((input as att.Mpair).args[0]), att.Nat.from_mich((input as att.Mpair).args[1]), att.Nat.from_mich((input as att.Mpair).args[2]));
    }
}
export class burn_event implements att.ArchetypeType {
    constructor(public bee_consumer: att.Address, public bee_token_id: att.Nat, public bee_amount: att.Nat) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.bee_consumer.to_mich(), this.bee_token_id.to_mich(), this.bee_amount.to_mich()]);
    }
    equals(v: burn_event): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): burn_event {
        return new burn_event(att.Address.from_mich((input as att.Mpair).args[0]), att.Nat.from_mich((input as att.Mpair).args[1]), att.Nat.from_mich((input as att.Mpair).args[2]));
    }
}
export class transfer_event implements att.ArchetypeType {
    constructor(public te_from: att.Address, public te_to: att.Address, public te_token_id: att.Nat, public te_amount: att.Nat) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.te_from.to_mich(), this.te_to.to_mich(), this.te_token_id.to_mich(), this.te_amount.to_mich()]);
    }
    equals(v: transfer_event): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): transfer_event {
        return new transfer_event(att.Address.from_mich((input as att.Mpair).args[0]), att.Address.from_mich((input as att.Mpair).args[1]), att.Nat.from_mich((input as att.Mpair).args[2]), att.Nat.from_mich((input as att.Mpair).args[3]));
    }
}
...
const set_aleph_contract_arg_to_mich = (): att.Micheline => {
    return att.unit_mich;
}
...
const mint_arg_to_mich = (iowner: att.Address, itokenid: att.Nat, itokenMetadata: Array<[
    string,
    att.Bytes
]>, iroyalties: Array<part>, iamount_aleph: att.Nat, ihash: string): att.Micheline => {
    return att.pair_to_mich([
        iowner.to_mich(),
        itokenid.to_mich(),
        ...
        iamount_aleph.to_mich(),
        att.string_to_mich(ihash)
    ]);
}
const burn_arg_to_mich = (itokenid: att.Nat): att.Micheline => {
    return itokenid.to_mich();
}
...
const collect_arg_to_mich = (dst: att.Address): att.Micheline => {
    return dst.to_mich();
}
...
export class Nft_fa21 {
    ...
    async deploy(owner: att.Address, permits: att.Address, aleph_tokens: att.Address, aleph_sync: att.Address, params: Partial<ex.Parameters>) {
        const address = (await ex.deploy("./contracts/nft_fa21.arl", {
            owner: owner.to_mich(),
            permits: permits.to_mich(),
            aleph_tokens: aleph_tokens.to_mich(),
            aleph_sync: aleph_sync.to_mich()
        }, params)).address;
        this.address = address;
    ...
    async set_aleph_contract(params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "set_aleph_contract", set_aleph_contract_arg_to_mich(), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async mint(iowner: att.Address, itokenid: att.Nat, itokenMetadata: Array<[
        string,
        att.Bytes
    ]>, iroyalties: Array<part>, iamount_aleph: att.Nat, ihash: string, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "mint", mint_arg_to_mich(iowner, itokenid, itokenMetadata, iroyalties, iamount_aleph, ihash), params);
        }
        throw new Error("Contract not initialised");
    }
    async burn(itokenid: att.Nat, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "burn", burn_arg_to_mich(itokenid), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async collect(dst: att.Address, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "collect", collect_arg_to_mich(dst), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_set_aleph_contract_param(params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "set_aleph_contract", set_aleph_contract_arg_to_mich(), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_mint_param(iowner: att.Address, itokenid: att.Nat, itokenMetadata: Array<[
        string,
        att.Bytes
    ]>, iroyalties: Array<part>, iamount_aleph: att.Nat, ihash: string, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "mint", mint_arg_to_mich(iowner, itokenid, itokenMetadata, iroyalties, iamount_aleph, ihash), params);
        }
        throw new Error("Contract not initialised");
    }
    async get_burn_param(itokenid: att.Nat, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "burn", burn_arg_to_mich(itokenid), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_collect_param(dst: att.Address, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "collect", collect_arg_to_mich(dst), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_aleph_tokens(): Promise<att.Address> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
    ...
    async get_aleph_sync(): Promise<att.Address> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
    ...
    async get_owner_candidate(): Promise<att.Option<att.Address>> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Option.from_mich((storage as att.Mpair).args[4], x => { return att.Address.from_mich(x); });
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_ledger_value(key: att.Nat): Promise<att.Address | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[7]).toString()), key.to_mich(), ledger_key_mich_type);
            if (data != undefined) {
    ...
    async get_royalties_value(key: att.Nat): Promise<Array<part> | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[8]).toString()), key.to_mich(), royalties_key_mich_type);
            if (data != undefined) {
    ...
    async get_operator_value(key: operator_key): Promise<operator_value | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[9]).toString()), key.to_mich(), operator_key_mich_type);
            if (data != undefined) {
    ...
    async get_operator_for_all_value(key: operator_for_all_key): Promise<operator_for_all_value | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[10]).toString()), key.to_mich(), operator_for_all_key_mich_type);
            if (data != undefined) {
    ...
    register_balance_event(ep: el.EventProcessor<balance_event>) {
        if (this.address != undefined) {
            el.registerEvent({ source: this.address, filter: tag => { return tag == "balance_event"; }, process: (raw: any, data: el.EventData | undefined) => {
                    const event = (x => {
                        return balance_event.from_mich(x);
                    })(raw);
                    ep(event, data);
                } });
            return;
    ...
    register_mint_event(ep: el.EventProcessor<mint_event>) {
        if (this.address != undefined) {
            el.registerEvent({ source: this.address, filter: tag => { return tag == "mint_event"; }, process: (raw: any, data: el.EventData | undefined) => {
                    const event = (x => {
                        return mint_event.from_mich(x);
                    })(raw);
                    ep(event, data);
                } });
            return;
    ...
    register_burn_event(ep: el.EventProcessor<burn_event>) {
        if (this.address != undefined) {
            el.registerEvent({ source: this.address, filter: tag => { return tag == "burn_event"; }, process: (raw: any, data: el.EventData | undefined) => {
                    const event = (x => {
                        return burn_event.from_mich(x);
                    })(raw);
                    ep(event, data);
                } });
            return;
    ...
    errors = {
        ...
        r11: att.pair_to_mich([att.string_to_mich("\"INVALID_CONDITION\""), att.string_to_mich("\"r11\"")]),
...
export const nft_fa21 = new Nft_fa21();
